...
\newglossaryentry{Mmat}{
    category=arg,% requires an argument
    name=\ensuremath{\mathbold{M}_{k}},
    text=\mathbold{M}_{\glsarg},
    description={$k$th min norm matrix containing the past $k$ solutions to the minimum norm problem.},
    type=symbolslist %in own list
}
\newglossaryentry{M}{
    category=arg,% requires an argument
    name=\ensuremath{\mathcal{M}_{k}},
    text=\mathcal{M}_{\glsarg},
    description={set of $k$ past min norm points $\gls{rho}_i$},
    type=symbolslist %in own list
}
\newglossaryentry{Mtildemat}{
    category=arg,% requires an argument
    name=\ensuremath{\mathbold{\tilde{M}}_{k}},
    text=\mathbold{\tilde{M}}_{\glsarg},
    description={$k$th min norm matrix containing the past $k-1$ solutions to the minimum norm problem and the current residual.},
    type=symbolslist %in own list
}
\newglossaryentry{Mtilde}{
    category=arg,% requires an argument
    name=\ensuremath{\tilde{\mathcal{M}}_{k}},
    text=\tilde{\mathcal{M}}_{\glsarg},
    description={set of $k-1$ past min norm points $\gls{rho}_i$+current residual},
    type=symbolslist %in own list
}
\newglossaryentry{c}{
    category=arg,% requires an argument
    name=\ensuremath{c_{k}},
    text=c_{\glsarg},
    description={ratio between norm of $\gls{rho}[k]$ and $\gls{rho}[k+1]$},
    type=symbolslist %in own list
}
\newglossaryentry{ctildevec}{
    category=arg,% requires an argument
    name=\ensuremath{\mathbold{\tilde{c}}_{k}},
    text=\mathbold{\tilde{c}}_{\glsarg},
    description={vector formed by 1 and then cumulative increasing product of $k-1$ scalars $\gls{c}[i]$},
    type=symbolslist %in own list
}
\newglossaryentry{KMSmat}{
    category=arg,% requires an argument
    name=\ensuremath{\mathbold{C}_{k}},
    text=\mathbold{C}_{\glsarg},
    description={slightly generalised \gls{kms} matrix.},
    type=symbolslist %in own list
}
\newglossaryentry{KMSLtilde}{
    category=arg,% requires an argument
    name=\ensuremath{\mathbold{\tilde{L}}_{k}},
    text=\mathbold{\tilde{L}}_{\glsarg},
    description={inverse bit of \gls{kms} decomposition.},
    type=symbolslist %in own list
}
\newglossaryentry{KMSL}{
    category=arg,% requires an argument
    name=\ensuremath{\mathbold{L}_{k}},
    text=\mathbold{L}_{\glsarg},
    description={inverse bit of \gls{kms} decomposition.},
    type=symbolslist %in own list
}
\newglossaryentry{KMSl}{
    ...
    name=\ensuremath{\mathbold{l}_{k}},
    text=\mathbold{l}_{\glsarg},
    description={last row of the Cholesky decomposition of \gls{kms}.},
    type=symbolslist %in own list
}
\newglossaryentry{KMSlpert}{
    category=arg,% requires an argument
    name=\ensuremath{\mathbold{\tilde{l}}_{k}},
    text=\mathbold{\tilde{l}}_{\glsarg},
    description={perturbed last row of the Cholesky decomposition of \gls{kms}.},
    type=symbolslist %in own list
}
\newglossaryentry{KMSD}{
    category=arg,% requires an argument
    name=\ensuremath{\mathbold{D}_{k}},
    text=\mathbold{D}_{\glsarg},
    description={diagonal part of KMS decomposition.},
    type=symbolslist %in own list
}
...
\newglossaryentry{ew}{
    %category=arg,
    name={\ensuremath{\mathbold{\tilde{e}}}},
    text={\mathbold{\tilde{e}}},
    description={Vector of weird 1s}, %not sure about the order here yet!
    type=symbolslist
}
\newglossaryentry{eps}{
    category=arg,% requires an argument
...
\newabbreviation{kms}{KMS}{Kac-Murdoch-Szeg\"o}
