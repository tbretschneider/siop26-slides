...
\begin{frame}{Convergence of \gls{aa}}
    \begin{itemize}
        ...
        \item Then in \parencite{Garner2023} for windowed \gls{aa} on symmetric maps strict
            improvement bounds are shown. \pause
        \item Later \parencite{De_Sterck2022} also for restarted \gls{aa} on further normal
            linear systems explicit convergence rates are found. \pause
        \item {\color{red} We still don't have a full appreciation of when, and to what
            extent \gls{aa} (any variant) improves upon \gls{pi} (even just on
            \textbf{linear maps}).}
    \end{itemize}
\end{frame}
